...
Étudier l'accessibilité multimodale d'un lieu ou d'un ensemble de lieux revient donc à mesurer puis à comparer les possibilités de déplacement et leur pénibilité associée en tenant compte de l'ensemble des modes de transport disponibles : transports en commun, à pieds, à vélo, ou en voiture, notamment.
...
<p class="center">
[<span style="font-size: 230%;" class="glyphicon glyphicon-download-alt"></span><br/>Télécharger les données](https://zenodo.org/records/10027161)</p>
...
Les cartes d'isochrones représentent des zones d'accessibilité égale (en distance ou en temps de déplacement notamment) à partir d'un certain point de départ. Elles figurent généralement plusieurs zones d'accessibilité, afin de représenter les différentiels croissants de coût du déplacement à mesure que l'on s'éloigne du lieu d'intérêt.
